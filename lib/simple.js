...
`.trim()
    ...
    /**
     * this sendMessage Button With Media
     * @param {Object} m chat in
     * @param {String} text this text
     * @param {String} footerText this footer
     * @param {String[]} buttons button array 
     * @param {Buffer} buffer button array 
     * @param {Object} opts option Message
     * @returns 
     */
     async sendButtonImage(m, text, footerText = '', buttons = [], Buffer, opts = {}) {
      let img = await this.prepareMessage(m, Buffer, MessageType.image)
      let buttonMessage = {
      ...
      return this.sendMessage(m, buttonMessage, MessageType.buttonsMessage, opts)
    }
    /**
     * send Message Button Only Text
     * @param {Object} m  chat in
     * @param {String} text this text
     * @param {String} footerText this footerText
     * @param {String[]} buttons this button array
     * @param {Object} opts option Message
     * @returns 
     */
    async sendButtonText(m, text, footerText = '', buttons = [], opts = {}) {
      let buttonMessage = {
          contentText: text,
          footerText: footerText,
          buttons: buttons,
