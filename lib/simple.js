    ...
    */
    ...
    getName(jid, withoutContact = false) {
      ...
      if (jid.endsWith('@g.us')) {
        ...
        else if (withoutContact) v = this.contacts[jid]
        else v = this.contactAddOrGet(jid) || {}
        return (withoutContact ? (v.vnmae || v.notify || v.name || ('+' + v.jid.split`@`[0])) : v.name) || v.subject || v.vname || v.notify || v.short || PhoneNumber('+' + jid.replace('@s.whatsapp.net', '')).getNumber('international')
      }
    }
